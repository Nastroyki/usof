...
import { patchPost } from '../http/postsAPI';
...
const EditPost = (props) => {
    ...
    let saveNewPost = async () => {
        ...
        try {
            await patchPost(props.post.id, postTitle, postContent, tags, props.post.status);
        } catch (err) {
    ...
    return (
        <form name="form" className="new-post-form">
            ...
            <div className="form-new-post-section">
                <button className="np-button" type='buttton' onClick={saveNewPost}>Save</button>
